    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center mb-6 md:mb-8">
          ...
          <h1 className="text-xl md:text-2xl font-semibold text-white text-center">Bem-vindo de volta</h1>
          <p className="text-sm text-gray-500 mt-1 text-center">Entre na sua conta para continuar</p>
        </div>
